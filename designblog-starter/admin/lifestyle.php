...
<head>
    ...
    <meta name="description" content="Tambah Berita Lifestyle - Admin Panel" />
    <meta name="author" content="Admin" />
    <title>Tambah Berita Lifestyle - Admin Panel</title>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Tambah Berita Lifestyle</h1>
                    <div class="card mb-4">
                        <div class="card-body">
                            <?php
                            if (isset($_POST['submit'])) {
                                ...
                                if (move_uploaded_file($_FILES["images"]["tmp_name"], $target_file)) {
                                    // Masukkan data ke database dengan kategori lifestyle
                                    $sql = "INSERT INTO artikel (judul, isi, author, tanggal_publikasi, images, kategori) VALUES (?, ?, ?, ?, ?, 'Lifestyle')";
                    ...
                    <!-- Tabel Berita Lifestyle -->
                    <h2 class="mt-4">Daftar Berita Lifestyle</h2>
                    <div class="card mb-4">
                        <div class="card-body">
